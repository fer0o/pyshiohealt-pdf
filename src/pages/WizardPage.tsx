      ...
      <section className="mx-auto w-full max-w-[816px]">
        ...
        <section className="rounded-lg border border-neutral-300 bg-white px-6 py-7 shadow-sm">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <button
              className="h-11 rounded-md bg-[#263b70] px-5 text-sm font-bold text-white transition hover:bg-[#1c2d58] disabled:cursor-not-allowed disabled:opacity-45"
              disabled={!isSessionCountConfirmed}
              type="button"
